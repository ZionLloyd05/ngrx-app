...
export class CustomerEffect {
    ...
    @Effect()
    loadCustomer$: Observable<Action> = this.action$
        .pipe(
    ...
    @Effect()
    createCustomer$: Observable<Action> = this.action$
        .pipe(
    ...
    @Effect()
    updateCustomer$: Observable<Action> = this.action$
        .pipe(
    ...
    @Effect()
    deleteCustomer$: Observable<Action> = this.action$
        .pipe(
